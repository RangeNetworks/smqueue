...
INSERT INTO "CONFIG" VALUES('SIP.Default.BTSPort','5062',0,0,'The default BTS port to try when none is available.');
...
INSERT INTO "CONFIG" VALUES('SIP.Timeout.MessageBounce','15',1,1,'Timeout, in seconds, between bounced message sending tries.');
...
INSERT INTO "CONFIG" VALUES('SMS.HTTPGateway.Retries',5,0,1,'Maximum retries for HTTP gateway attempt.  If SMS.HTTPGateway.URL is defined, this must also be defined."');
